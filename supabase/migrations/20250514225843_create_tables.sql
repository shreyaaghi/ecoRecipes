...
create table public.included_plans (
  id bigint generated by default as identity not null,
  meal_plan_id bigint null,
  created_at timestamp with time zone not null default now(),
  recipe_plan_id bigint null,
  constraint included_plans_pkey primary key (id),
  constraint included_plans_meal_plan_id_fkey foreign KEY (meal_plan_id) references meal_plans (id) on update CASCADE on delete CASCADE,
  constraint included_plans_recipe_plan_id_fkey foreign KEY (recipe_plan_id) references recipe_plans (id) on update CASCADE on delete CASCADE
) TABLESPACE pg_default;

create table public.meal_plans (
  id bigint generated by default as identity not null,
  user_id uuid not null,
  included_plans_id bigint not null,
  created_at timestamp with time zone not null default now(),
  name text null,
  constraint meal_plans_pkey primary key (id),
  constraint meal_plans_user_id_fkey foreign KEY (user_id) references users (id) on update CASCADE on delete CASCADE,
  constraint meal_plans_included_plans_id_fkey foreign KEY (included_plans_id) references included_plans (id) on update CASCADE on delete CASCADE
) TABLESPACE pg_default;

create table public.recipe_plans (
  id bigint generated by default as identity not null,
  recipe_id bigint not null,
  created_at timestamp with time zone not null default now(),
  day text null,
